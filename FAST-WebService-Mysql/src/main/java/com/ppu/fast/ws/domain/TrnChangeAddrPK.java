...
@Embeddable
public class TrnChangeAddrPK implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8715529833338381873L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TrnChangeAddrPK other = (TrnChangeAddrPK) obj;
		if (contractNo == null) {
