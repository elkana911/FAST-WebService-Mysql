...
/**
 * Dont use this, under development
...
public class Currency {
	...
	public static final String CURR_SGD = "SGD";	
	
	public static final String[] supportedCurrency = {CURR_IDR};
...
//					soFar = " SERATUS" + soFar;
	...
	public static String format(String countryId, String s, boolean showLabel) {
...
//        System.out.printf("Harga Rupiah: %s %n", kursIndonesia.format(harga));	
	...
	public static void main(String[] args) {
		System.err.println(Currency.say("120000"));
//		System.err.println(Currency.format("120000", false));
