...
@Embeddable
public class TrnLDVDetailsPK implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -4085412017263369866L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TrnLDVDetailsPK other = (TrnLDVDetailsPK) obj;
		if (ldvNo == null) {
			if (other.ldvNo != null)
				return false;
